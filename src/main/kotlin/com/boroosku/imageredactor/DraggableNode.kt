...
abstract class DraggableNode : AnchorPane() {
    ...
    open fun toData(): NodeData {
        return NodeData(id, this::class.simpleName!!, rootPane?.layoutX, rootPane?.layoutY, null, null)
    }
...
data class NodeData(val id: String, val name: String, val x: Double?, val y: Double?, var data: String?, val type: ButtonTypes?)